            ...
            <div class="col-md-6 col-12">
                <form method="POST" action="{{ route('login_post') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('login') is-invalid @enderror" id="inputLogin"
                               name="login"
                               aria-describedby="inputLoginValidation">
                        @error('login')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                               ...
                               aria-describedby="inputPasswordValidation">
                        @error('password')
